		...
		<body>
				...
				<?php
							...
							$R->execute(array(											
									...
									echo ' <a id="edit_done" href="edit_done.php?id='.$_GET['id_done'].'&year='.$_GET['year'].'&month='.$_GET['month'].'&day='.$_GET['day'].'" target="_blank"> edit done </a> ';
									echo'<iframe id="delet_done" src="delet_done.php?id='.$_GET['id_done'].'&type=news&year='.$_GET['year'].'&month='.$_GET['month'].'&day='.$_GET['day'].'" height="40" width="80" SCROLLING="no" NORESIZE FRAMEBORDER="0"></iframe>';
